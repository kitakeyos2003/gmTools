...
<body>
<%--<div align="center"> <a href="/gmTools/manage/gmLetters?ajax=jquery">刷新</a>  </div><br />--%>
...
<form name="paginationoptions">
    <input type="hidden" name="acount" id="acount" value="<s:property value="gmLetterNumber"/> ">
...
<script type="text/javascript">
    function pageselectCallback(page_index, jq){
        ...
        var url = "/gmTools/manage/gmLetters";
        var params = "next_page="+(page_index+1)+"&per_page="+items_per_page;
