...
<div> <input type="radio" onclick="document.location='/gmTools/manage/auditModifyPlayerInfoList?type=3&flag=0&ajax=jquery'">尚未审核 &nbsp;&nbsp;
   <input type="radio" onclick="document.location='/gmTools/manage/auditModifyPlayerInfoList?type=3&flag=1&ajax=jquery'"> 已审核通过 &nbsp;&nbsp;
 <input type="radio" onclick="document.location='/gmTools/manage/auditModifyPlayerInfoList?type=3&flag=2&ajax=jquery'">已审核未通过 &nbsp;&nbsp;
 <input type="radio" onclick="document.location='/gmTools/manage/auditModifyPlayerInfoList?type=3&flag=-1&ajax=jquery'">所有
</div>
<div>
<table width="800" border="1">
  <tr>
    ...
    <th class="header1" scope="col">金钱</th>
    <th class="header1" scope="col">等级</th>
    <th class="header1" scope="col">爱情值</th>
    <th class="header1" scope="col">技能点</th>
  ...
  <tr>
    ...
    <td><s:property value="loverValue"/></td>
    <td><s:property value="skillPoint"/> </td>
    <td><s:property value="gmName"/> </td>
    <td><s:property value="memo"/></td>
    <td> <s:date name="createTime" format="yyyy-MM-dd HH:mm:ss"/> </td>
    <td> <span id="aid_<s:property value="id"/>">
        <s:if test="flag==0">
        <input type="button" value="通过" onclick="audit(3,<s:property value="id"/>,1,<s:property value="serverID"/>)"> &nbsp;&nbsp;
        <input type="button" value="不通过" onclick="audit(3,<s:property value="id"/>,2,<s:property value="serverID"/>)">
        </s:if>
