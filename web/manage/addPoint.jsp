...
<body>
 <h1 class="datepick-ctrl">给玩家加点</h1>
<span>选择服务器：<select id="serverID" name="serverID">
    ...
    <span>账号: <select id="type" name="type">
     ...
     <span>点数：<input type="text" name="point" id="point" value="0"/></span>
    <br/>    <br/>
 <span>原因：<textarea rows="5" cols="60" name="memo" id="memo"></textarea>   </span>
    <br/><br/>
    <input type="button" value="提交" id="but" onclick="addpoint()"/>  &nbsp;&nbsp; <input type="button" value="取消" id="cancelbut" />
    <br/>
    <span id="pointid" style="color:red"></span>
